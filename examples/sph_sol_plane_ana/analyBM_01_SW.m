...
text(0.50*ax1(2),0.88*ax1(4),'t=35','fontsize',14)
if ~isnan(err)
text(0.70*ax1(2),0.65*ax1(4),[str3 ' - NRMSD=' num2str(err,'%3.0f') '%'],'fontsize',12)
end
if ~isnan(err1)
text(0.65*ax1(2),0.40*ax1(4),[' - ERR Max Wave Amp =' num2str(err1,'%3.0f') '%'],'fontsize',12)
end
...
ax1=[-2 20 -0.02 0.04001];
axis(ax1)
text(0.50*ax1(2),0.88*ax1(4),'t=40','fontsize',14)
if ~isnan(err)
text(0.70*ax1(2),0.65*ax1(4),[str3 ' - NRMSD=' num2str(err,'%3.0f') '%'],'fontsize',12)
end
if ~isnan(err1)
...
axis(ax1)
text(0.50*ax1(2),0.88*ax1(4),'t=45','fontsize',14)
if ~isnan(err)
text(0.70*ax1(2),0.65*ax1(4),[str3 ' - NRMSD=' num2str(err,'%3.0f') '%'],'fontsize',12)
end
if ~isnan(err1)
...
text(0.50*ax1(2),0.88*ax1(4),'t=50','fontsize',14)
if ~isnan(err)
text(0.70*ax1(2),0.65*ax1(4),[str3 ' - NRMSD=' num2str(err,'%3.0f') '%'],'fontsize',12)
end
if ~isnan(err1)
...
axis(ax1)
text(0.50*ax1(2),0.88*ax1(4),'t=55','fontsize',14)
if ~isnan(err)
text(0.70*ax1(2),0.65*ax1(4),[str3 ' - NRMSD=' num2str(err,'%3.0f') '%'],'fontsize',12)
end
if ~isnan(err1)
...
ax1=[-2 20 -0.02 0.08001];
axis(ax1)
text(0.50*ax1(2),0.88*ax1(4),'t=60','fontsize',14)
if ~isnan(err)
text(0.70*ax1(2),0.65*ax1(4),[str3 ' - NRMSD=' num2str(err,'%3.0f') '%'],'fontsize',12)
end
if ~isnan(err1)
...
text(0.50*ax1(2),0.88*ax1(4),'t=65','fontsize',14)
if ~isnan(err)
text(0.70*ax1(2),0.65*ax1(4),[str3 ' - NRMSD=' num2str(err,'%3.0f') '%'],'fontsize',12)
end
if ~isnan(err1)
...
if ~isnan(err)
text(0.70*ax1(2),0.65*ax1(4),[str4 ' - NRMSD=' num2str(err,'%3.0f') '%'],'fontsize',12)
end
if ~isnan(err1)
text(0.65*ax1(2),0.40*ax1(4),[' - ERR Max Runup Amp =' num2str(err1,'%3.0f') '%'],'fontsize',12)
end
